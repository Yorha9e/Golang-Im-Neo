...
export const getApiBaseUrl = (): string => {
  if (typeof window !== 'undefined' && (window.location.protocol === 'file:' || (window as any).electronAPI?.isElectron || (window as any).Capacitor)) {
    return 'https://106.52.170.56:8080/api/v1';
  }
  return '/api/v1';
};
